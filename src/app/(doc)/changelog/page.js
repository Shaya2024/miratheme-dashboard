        ...
        >
          ...
          <Box mt={3}>
            <Typography variant="subtitle1">
              <Chip color="secondary" label="v6.0.0" /> – Apr 5, 2025
              <ul>
                <li>Migrate jsonwebtoken to jose</li>
                <li>Fix issue with horizontal overflow in layouts</li>
                <li>Upgrade to MUI v7.0.1</li>
                <li>Upgrade to React v19.1.0</li>
                <li>Upgrade to Next.js v15.2.4</li>
                <li>Upgrade to Vite v6.2.5</li>
                <li>Upgrade to ApexCharts v4.5.0</li>
                <li>Upgrade to Redux v5.0.1</li>
                <li>Upgrade to Node v22.14.0</li>
