...
// Add custom styles for the date picker header
...
const CustomHeader = ({
    ...
    <div style={customHeaderStyles.header}>
        <button
            onClick={decreaseMonth}
            disabled={prevMonthButtonDisabled}
            style={customHeaderStyles.navButton}
            type="button"
        >
            ←
        </button>
        <span style={customHeaderStyles.monthYear}>
...
const customDatePickerStyles = `
  ...
  .react-datepicker__day:hover {
    background-color:rgb(1, 66, 71) !important;
...
const FilterBar = ({ filters, setFilters, facilityOptions = [], stateOptions = [] }) => {
    ...
    return (
        <Box
            ...
            sx={{
                color: 'grey.800',
                bgcolor: '#fff', borderRadius: 2, boxShadow: 2,
                px: 2,
                py: 1.75,
                '& > *': {
                    minWidth: '200px',
        ...
        >
                                                ...
                                                <Box
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        if (preset.type === 'thisWeek') {
                                                            ...
                                                            start = new Date(today);
                                                            start.setMonth(today.getMonth() - preset.months);
                                                            end = today;
            ...
            {/* State Filter */}
            <FormControl sx={{ minWidth: '200px', position: 'relative', justifyContent: 'center' }}>
                <Typography
                    variant="caption"
                    sx={{
                        position: 'absolute',
                ...
                <Select
                    ...
                    renderValue={(selected) => {
                        if (selected.length === 0) {
                            return <Typography sx={{ color: 'grey.800' }}>All</Typography>;
                        }
                ...
                >
                    ...
                    {stateOptions.map((state) => (
                        <MenuItem key={state} value={state} sx={{
                            color: 'grey.800',         // text color
                            '&:hover': {
                                backgroundColor: '#f0f7ff', // background on hover
                            },
                            '&.Mui-selected': {
                                backgroundColor: '#e0f7fa', // background when selected
                                color: 'grey.800',
                            },
                            '&.Mui-selected:hover': {
            ...
            <FormControl sx={{ minWidth: '200px', position: 'relative', justifyContent: 'center' }}>
                ...
                >
                    ...
                    {facilityOptions.map((facility) => (
                        <MenuItem key={facility} value={facility} sx={{
                            color: 'grey.800',         // text color
                            '&:hover': {
                                backgroundColor: '#f0f7ff', // background on hover
                            },
